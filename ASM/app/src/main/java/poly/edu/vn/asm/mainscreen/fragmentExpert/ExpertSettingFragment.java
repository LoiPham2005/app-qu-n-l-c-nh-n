package poly.edu.vn.asm.mainscreen.fragmentExpert;
...
public class ExpertSettingFragment extends Fragment {
    ...
    public ExpertSettingFragment() {
        // Required empty public constructor
    }


    public static ExpertSettingFragment newInstance() {
        ExpertSettingFragment fragment = new ExpertSettingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_expert_setting, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnLogout = view.findViewById(R.id.btnLogoutExpert);
